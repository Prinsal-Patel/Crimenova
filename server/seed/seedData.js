...
const cityRateIndex = {
  'Delhi': 1.8, 'Mumbai': 0.9, 'Bangalore': 1.1, 'Chennai': 0.8, 'Kolkata': 0.6,
  'Hyderabad': 0.7, 'Pune': 0.85, 'Jaipur': 1.3, 'Ahmedabad': 0.75, 'Lucknow': 1.4
};
...
const seedDB = async () => {
  try {
    await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/crimenova');
    ...
    console.log(`📊 Inserted ${crimes.length} NCRB real-world based crime records`);
